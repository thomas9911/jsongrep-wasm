...
function queryWithPath(arg0, arg1) {
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query-with-path"][Instruction::CallWasm] enter', {
    funcName: 'query-with-path',
    paramCount: 4,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'jsongrep010QueryWithPath',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => jsongrep010QueryWithPath(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query-with-path"][Instruction::Return]', {
    funcName: 'query-with-path',
    paramCount: 1,
    async: false,
    postReturn: true
...
function query(arg0, arg1) {
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query"][Instruction::CallWasm] enter', {
    funcName: 'query',
    paramCount: 4,
    async: false,
    postReturn: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => jsongrep010Query(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query"][Instruction::Return]', {
    funcName: 'query',
    paramCount: 1,
    async: false,
    postReturn: true
...
let jsongrep010QueryFirst;

function queryFirst(arg0, arg1) {
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query-first"][Instruction::CallWasm] enter', {
    funcName: 'query-first',
    paramCount: 4,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'jsongrep010QueryFirst',
    getCallbackFn: () => null,
    callbackFnName: 'null',
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  let ret =   _withGlobalCurrentTaskMeta({
    taskID: task.id(),
    componentIdx: task.componentIdx(),
    fn: () => jsongrep010QueryFirst(ptr0, len0, ptr1, len1),
  });
  ...
  _debugLog('[iface="jsongrep:jsongrep/jsongrep@0.1.0", function="query-first"][Instruction::Return]', {
    funcName: 'query-first',
    paramCount: 1,
    async: false,
    postReturn: true
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./jsongrep_wasm.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./jsongrep_wasm.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
...
export { jsongrep010 as jsongrep, jsongrep010 as 'jsongrep:jsongrep/jsongrep@0.1.0',  }